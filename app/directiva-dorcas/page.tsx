...
import { getDirectivaDorcasGenerations, getRegionConfig } from "@/lib/api";
import { buildPageMetadata } from "@/lib/seo";

export const revalidate = false;

export const metadata: Metadata = buildPageMetadata({
  title: "Directiva de Dorcas",
  description:
    "Conoce a los miembros de la directiva de Dorcas de la Región Mayo y contacta con ellos.",
  canonicalPath: "/directiva-dorcas",
});

export default async function DirectivaDorcasPage() {
