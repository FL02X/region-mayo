...
import { Images, ExternalLink, Calendar, MapPin, Info } from "lucide-react"
    ...
    <div className="px-4 py-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-muted/50 rounded-2xl p-4 mb-6 border flex items-start gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            Los albums de fotos se almacenan en Google Drive. Despues de cada evento, 
            podras acceder al album para ver y compartir tus fotos favoritas.
          </p>
        </div>

        {/* Albums Grid - Centered when few cards */}
