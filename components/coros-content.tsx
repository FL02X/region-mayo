          ...
          <div className="space-y-3 pt-2 border-t">
            ...
            <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-xl">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-foreground truncate">{coro.presidentName}</p>
                <p className="text-xs text-muted-foreground">Presidente</p>
              </div>
              <WhatsAppIconButton 
                phone={coro.presidentPhone} 
                message={`Hola, me comunico del sitio web de Región Mayo respecto al ${coro.coroName}`}
              />
            </div>
