...
// Donde: paginas internas de secciones como album/subida. 
// Viewports: desktop y mobile.
// Funcion: muestra volver y compartir.
...
const sectionNavActionButtonClass =
  "inline-flex h-10 w-fit items-center gap-2.5 rounded-sm border border-transparent bg-transparent px-3 text-sm font-medium text-black transition-[background-color,border-color] duration-150 hover:border-[var(--border)] hover:bg-surface-pane focus:outline-none focus-visible:ring-2 focus-visible:ring-[#005998]";
