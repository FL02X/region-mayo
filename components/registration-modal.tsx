        ...
        >
              ...
              <div className="flex items-center">
                {[1, 2, 3].map((s, index) => (
                  <div key={s} className="flex items-center flex-1 last:flex-none">
                    ...
                    {index < 2 && (
                      <div className={`flex-1 h-0.5 mx-2 rounded-full transition-colors ${s < step ? "bg-[#FF6B35]" : "bg-muted"}`} />
                    )}
                  </div>
                ))}
              </div>
                ...
                {stepLabels.map((label, index) => (
                  ...
                  >
                    <span 
                      ...
                      } ${step === index + 1 ? "text-[#FF6B35] font-medium" : "text-muted-foreground"}`}
                    >
                      {label}
                    </span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-xl">
                  ...
                  <div className="flex gap-1.5">
                    <Button
                      ...
                      className={`rounded-lg h-8 px-3 text-xs ${formData.isVisiting ? "bg-[#FF6B35] hover:bg-[#FF6B35]/90" : ""}`}
                    >
                      Sí
                    </Button>
                    <Button
                ...
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-xl">
                  ...
                  <div className="flex gap-1.5">
                    <Button
                      ...
                      className={`rounded-lg h-8 px-3 text-xs ${formData.needsLodging ? "bg-[#FF6B35] hover:bg-[#FF6B35]/90" : ""}`}
                    >
                      Sí
                    </Button>
                    <Button
                ...
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-xl">
                  ...
                  <div className="flex gap-1.5">
                    <Button
                      ...
                      className={`rounded-lg h-8 px-3 text-xs ${formData.needsTransport ? "bg-[#FF6B35] hover:bg-[#FF6B35]/90" : ""}`}
                    >
                      Sí
                    </Button>
                    <Button
                ...
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-xl">
                  ...
                  <div className="flex gap-1.5">
                    <Button
                      ...
                      className={`rounded-lg h-8 px-3 text-xs ${formData.isBaptized ? "bg-[#FF6B35] hover:bg-[#FF6B35]/90" : ""}`}
                    >
                      Sí
                    </Button>
                    <Button
                ...
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-xl">
                  ...
                  <div className="flex gap-1.5">
                    <Button
                      ...
                      className={`rounded-lg h-8 px-3 text-xs ${formData.isCoroMGR ? "bg-[#FF6B35] hover:bg-[#FF6B35]/90" : ""}`}
                    >
                      Sí
                    </Button>
                    <Button
                ...
                <div className="p-3 bg-muted/50 rounded-xl">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      className={`rounded-lg h-9 px-4 text-sm flex-1 ${formData.attendingAs === "oyente" ? "bg-[#FF6B35] hover:bg-[#FF6B35]/90" : ""}`}
                    >
                      Oyente
                    </Button>
                    <Button
                      ...
                      className={`rounded-lg h-9 px-4 text-sm flex-1 ${formData.attendingAs === "miembro" ? "bg-[#FF6B35] hover:bg-[#FF6B35]/90" : ""}`}
                    >
                      Miembro
                    </Button>
                  </div>
                    ...
                    <div className="relative">
                      <div className="grid grid-cols-3 gap-2">
                        {photos.slice(0, maxPhotosToShow).map((photo, index) => (
                          <button
                            ...
                            className="relative aspect-square rounded-xl overflow-hidden group focus:outline-none focus:ring-2 focus:ring-[#FF6B35] focus:ring-offset-2"
                          >
                            <Image 
                              src={photo} 
                      ...
                      {photos.length > maxPhotosToShow && (
                        <button
                          ...
                          className="mt-2 text-xs text-[#FF6B35] font-medium flex items-center gap-1 hover:underline"
                        >
            ...
            <div className="sticky bottom-0 bg-background border-t px-5 py-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="flex-1 rounded-xl h-11 bg-[#FF6B35] hover:bg-[#FF6B35]/90 text-white"
                >
                  {isSubmitting ? (
                    <>
          ...
          {step === 4 && (
            <div className="px-5 pb-5">
              <Button onClick={onClose} className="w-full rounded-xl h-11 bg-[#FF6B35] hover:bg-[#FF6B35]/90 text-white">
                Cerrar
              </Button>
            </div>
          )}
            ...
            {photos.map((photo, index) => (
              <button
                ...
                className={`relative w-14 h-14 rounded-lg overflow-hidden shrink-0 transition-all ${
                  index === currentIndex 
                    ? "ring-2 ring-[#FF6B35] ring-offset-2 ring-offset-black" 
  ...
  return (
    <div className="text-center py-6">
      <div className="w-14 h-14 bg-[#FF6B35]/10 rounded-full flex items-center justify-center mx-auto mb-4">
        <Check className="h-7 w-7 text-[#FF6B35]" />
      </div>
            ...
            {isContactExpanded && (
              <div className="mt-2 space-y-3 pt-2 border-t">
                <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-xl">
                  <div className="h-10 w-10 rounded-full bg-[#FF6B35]/10 flex items-center justify-center shrink-0">
