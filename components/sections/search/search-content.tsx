  ...
  if (isEntering && isMobile) {
    return (
      <div className="w-full relative bg-[#f1f1f1]" id="main-content">
        <div className="desktop-content-pane max-w-[1150px] mx-auto px-4 md:px-8 py-8 pt-[82px] md:pt-[88px] bg-[#ffffff] md:border-x border-[#dce2e9] dark:border-[#27272a] focus:outline-none">
