...
function SearchContentInner({ data }: SearchContentProps) {
  ...
  if (isEntering && isMobile) {
    return (
      <div className="w-full relative bg-[#f1f1f1]" id="main-content">
        <div className="desktop-content-pane max-w-[1150px] mx-auto px-4 md:px-8 py-8 pt-[32px] md:pt-[44px] bg-[#ffffff] md:border-x border-border dark:border-[#27272a] focus:outline-none">
  ...
  return (
    <div className="w-full relative bg-[#f1f1f1]" id="main-content">
      <div className="desktop-content-pane max-w-[1150px] min-h-[calc(110dvh-51px)] md:min-h-[calc(110dvh-45px)] mx-auto px-4 md:px-0 py-8 pt-[32px] md:pt-[44px] bg-paper md:border-x border-border dark:border-[#27272a] focus:outline-none">
