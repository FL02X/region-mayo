...
export function TemplosContent({ templos, initialViewMode }: TemploContentProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`desktop-content-pane ${shouldShowLoader ? "invisible" : "visible"} max-w-[950px] mx-auto px-4 md:px-8 py-8 pt-[82px] md:pt-[88px] bg-[#ffffff] md:border-x border-[#dce2e9] dark:border-[#27272a] focus:outline-none`}>
