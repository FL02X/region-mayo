    ...
    <div style={{ position: "fixed", bottom: "calc(20px + env(safe-area-inset-bottom, 0px))", right: "20px", zIndex: 40, fontFamily: "system-ui, -apple-system, sans-serif" }} className="md:right-5">
      {!isOpen ? (
        <>
          ...
          <button onClick={toggleChat} aria-label="Abrir Asistente" className="md:hidden flex items-center justify-center w-12 h-12 bg-[#21252b] text-white transition-transform active:scale-95" style={{ borderRadius: '50%', border: 'none', fontWeight: 600, boxShadow: '0 4px 12px rgba(0,0,0,0.15)' }}>
